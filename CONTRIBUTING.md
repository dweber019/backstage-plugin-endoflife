...
`backstage-plugin-endoflife` is [MIT licensed](LICENSE) and accepts contributions via
...
- GitHub [issues](https://github.com/dweber019/backstage-plugin-endoflife/issues)
...
```
git clone git@github.com:your_github_username/backstage-plugin-endoflife.git
cd backstage-plugin-endoflife
git remote add upstream https://github.com/dweber019/backstage-plugin-endoflife.git
git fetch upstream
```
...
[fork]: https://github.com/dweber019/backstage-plugin-endoflife/fork
